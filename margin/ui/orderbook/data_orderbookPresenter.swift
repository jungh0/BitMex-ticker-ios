...
protocol OrderView: NSObjectProtocol {
...
class data_orderbookPresenter{
    
    private var userView : OrderView?
    ...
    func attachView(_ view:OrderView){
        userView = view
    }
